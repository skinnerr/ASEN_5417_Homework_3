...
We find $F''(0) = \{0.64218, 0.41945\}$ for $\text{Pr} = \{1, 10\}$. Plots of $F$, $F'$, and $\theta$ as functions of the similarity variable are presented in \figref{fig:prob2_plots}.

\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.7\textwidth]{Problem2_F.eps}
\includegraphics[width=0.7\textwidth]{Problem2_Fprime.eps}
\includegraphics[width=0.7\textwidth]{Problem2_theta.eps}
\\
